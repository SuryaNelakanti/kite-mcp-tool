...
export const Icons = {
  // Logo
  zLogo: (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 512 512" fill="currentColor" {...props}>
      ...
      <path d="M368 160h-96v32h58.7L160 352h96v-32h-58.7L368 160z" />
    </svg>
  ),
  ...
  // Portfolio (briefcase)
  portfolio: (props: SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  // Market data (bar chart)
  marketData: (props: SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  // Chevron (for dropdowns, accordions)
  ...
  // Dollar sign (for currency values)
  ...
  // Pie chart
  pieChart: (props: SVGProps<SVGSVGElement>) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      height="24"
  ...
  // X (close) icon - alternative to 'close' with different styling
